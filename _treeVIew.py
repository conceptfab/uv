...
class Hierarchy(c4d.gui.TreeViewFunctions):
    ...
    def SetCheck(self, root, userdata, obj, column, checked, msg):
        ...
        self._dlg().SetString(1001, f"Checked: {status}")
    ...
    def InsertObject(
        self, root, userdata, obj, dragtype, dragobject, insertmode, bCopy
    ):
        """
...
class TestDialog(c4d.gui.GeDialog):
    ...
    def CreateLayout(self):
        ...
        self.AddMultiLineEditText(
            1001, c4d.BFH_SCALEFIT | c4d.BFV_SCALE | c4d.BFV_BOTTOM, 0, 40
        )
...
class MenuCommand(c4d.plugins.CommandData):
    ...
    def Execute(self, doc):
        ...
        return self.dialog.Open(c4d.DLG_TYPE_ASYNC, -1, defaulth=600, defaultw=600)
...
def main():
    dialog = TestDialog()
    dialog.Open(c4d.DLG_TYPE_ASYNC, -1, defaulth=600, defaultw=600)
